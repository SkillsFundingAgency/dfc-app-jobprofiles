...
//            services
//                .AddPolicies(policyRegistry, nameof(ContentApiConfiguration), policyOptions)
//                .AddHttpClient<IProvideGraphContent, GraphContentProvider, ContentApiConfiguration>(configuration, nameof(ContentApiConfiguration), nameof(PolicyOptions.HttpRetry), nameof(PolicyOptions.HttpCircuitBreaker));
