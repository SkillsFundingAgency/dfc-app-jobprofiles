...
namespace DFC.App.JobProfile.Repository.CosmosDb
{
    ...
    public class StaticCosmosRepository<T> : IStaticCosmosRepository<T>
        where T : IDataModel
    {
        private readonly StaticCosmosDbConnection cosmosDbConnection;
        private readonly IDocumentClient documentClient;
        private readonly IHostingEnvironment env;

        public StaticCosmosRepository(StaticCosmosDbConnection cosmosDbConnection, IDocumentClient documentClient, IHostingEnvironment env)
        {
