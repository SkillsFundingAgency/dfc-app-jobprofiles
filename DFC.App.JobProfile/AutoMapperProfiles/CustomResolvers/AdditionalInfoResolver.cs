...
namespace DFC.App.JobProfile.AutoMapperProfiles.CustomResolvers
{
    ...
    {
        public List<AdditionalInformation> Resolve(JobProfileHowToBecomeResponse source, CommonRoutes destination, List<AdditionalInformation> destMember, ResolutionContext context)
        {
            ...
            switch (routeName)
            {
                case RouteName.Apprenticeship:
                    if (responseData.RelatedApprenticeshipLinks.ContentItems != null && responseData.RelatedApprenticeshipRequirements.ContentItems != null)
                    {
                ...
                case RouteName.College:
                    if (responseData.RelatedCollegeLinks.ContentItems != null && responseData.RelatedCollegeRequirements.ContentItems != null)
                    {
                ...
                case RouteName.University:
                    if (responseData.RelatedUniversityLinks.ContentItems != null && responseData.RelatedApprenticeshipRequirements.ContentItems != null)
                    {
