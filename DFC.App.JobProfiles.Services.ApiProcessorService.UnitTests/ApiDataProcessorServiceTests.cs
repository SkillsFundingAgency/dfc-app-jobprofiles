...
namespace DFC.App.JobProfile.Services.ApiProcessorService.UnitTests
{
    ...
    public class ApiDataProcessorServiceTests
    {
        ...
        //{
        //    // arrange
        //    var expectedResult = new JobProfileItemModel
        //    {
        ...
        //    // act
        //    var result = await apiDataProcessorService.GetAsync<JobProfileItemModel>(A.Fake<HttpClient>(), new Uri("https://somewhere.com")).ConfigureAwait(false);
        ...
        //{
        //    // arrange
        //    JobProfileItemModel? expectedResult = null;
        ...
        //    // act
        //    var exceptionResult = await Assert.ThrowsAsync<ArgumentNullException>(async () => await apiDataProcessorService.GetAsync<JobProfileItemModel>(null, new Uri("https://somewhere.com")).ConfigureAwait(false)).ConfigureAwait(false);
